    ...
    return (
        <div className="wallpoet">
            ...
            <div className="flex justify-center pb-5">
                <input id="HelloInput" type="text" placeholder="Name" className="lg:px-5 text-lg lg:text-3xl flex justify-center text-black bg-yellow-300 text-center"></input>
            </div>

            <div className="flex justify-center pb-8">
                <button id="HelloCall" className="bg-yellow-300 text-black py-3 px-12 lg:px-16 rounded-full text-lg lg:text-3xl">Submit</button>
            </div>

            <p id="HelloResponse" className="mx-12 lg:mx-56 mb-48 text-yellow-300 text-center text-lg lg:text-3xl">Response</p>
        </div>
    )
}